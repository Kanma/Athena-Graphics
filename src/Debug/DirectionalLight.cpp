/** @file   DirectionalLight.cpp
    ...
    Implementation of the class 'Athena::Graphics::Debug::DirectionalLight'
*/
...
static const char*  __CONTEXT__             = "Debug/DirectionalLight";

///< Name of the type of component
const std::string   DirectionalLight::TYPE  = "Athena/Debug/DirectionalLight";
